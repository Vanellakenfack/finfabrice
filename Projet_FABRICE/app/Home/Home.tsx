...
export default function HomePage() {
  ...
  const visibleFeaturedProducts = !isLoadingFeatured && featuredProducts.length > 0
    ? featuredProducts
  ...
  const displayFeaturedProducts = visibleFeaturedProducts.map((prod) => {
    ...
    return {
      ...
      seller: isApiProduct ? undefined : (prod as any).seller,
      livraison: isApiProduct ? undefined : (prod as any).livraison,
    };
  });
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <span className="text-xl font-bold text-orange-600">{prod.priceLabel}</span>
                        {prod.old && (
                          <span className="text-xs text-gray-400 line-through ml-2">{prod.old}</span>
                        )}
                      </div>
